...
3) Если не получается что то обновить или скачать какой нибудь пакет, то делайте это действие, оно отключит проверку подлиности, что конечно же не безопасно. Ведь Габен, что то намутил и скачивание может обрубаться при проверке PGP сигнатур и поэтому может не работать.
...
5) Скачать последнюю версию zapret, но для линуха. Очень долго искал этот порт, но вот он, теперь вы сможете пользоваться YT или D даже на Дэке. [Тут](https://github.com/Sergeydigl3/zapret-discord-youtube-linux) <- Оригинальный проект и там же доп. инструкции, если что.
...
8) Установить или удалить Decky Loader. Это крутое дополнение для игрового режима, которые позволяет скачивать плагины, для упрощения жизни. [Тут](https://decky.xyz/) <- Это их сайт, там остальная инфа, или вот их github -> [Тут](https://github.com/SteamDeckHomebrew/decky-loader).
